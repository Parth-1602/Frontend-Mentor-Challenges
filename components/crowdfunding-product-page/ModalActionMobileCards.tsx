...
import { modalActionMobileCardsStyles } from "./styles";

const ModalActionMobileCards = ({ handlePledgeModal, handleSuccessModal }) => {
...
export default ModalActionMobileCards;
...
const ActionCard = ({
  ...
  const classes = useClasses(modalActionMobileCardsStyles);
    ...
    >
      ...
      <Box className={classes.stockWrapper}>
        <Typography
          variant="h6"
          component="h6"
          className={`${classes.stock} ${isDisabled && classes.stockDisabled}`}
        >
          {stock}
        </Typography>
        <Typography
